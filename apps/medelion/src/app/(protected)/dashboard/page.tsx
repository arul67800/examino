          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">Add a new question to the bank</p>
              </div>
            </button>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <p className="text-sm text-gray-600">
                <span className="font-medium">New question</span> added to Mathematics category
              </p>
            ...
            <div className="flex items-center space-x-3">
              ...
              <p className="text-sm text-gray-600">
                <span className="font-medium">Exam "Algebra Test"</span> completed by 25 students
              </p>
            ...
            <div className="flex items-center space-x-3">
              ...
              <p className="text-sm text-gray-600">
                <span className="font-medium">User feedback</span> received for Physics questions
              </p>
