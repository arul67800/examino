...
import { HierarchyMode, canHaveMCQs } from './hierarchy-config';
    ...
    if (onMCQClick) {
      ...
      switch (mcqEditView) {
        case 'modal':
          ...
          const hierarchyParams = createMCQNavigationParams(item);
        ...
        case 'page':
          ...
          navigateToNewMCQ(router, item, allHierarchyItems);
          break;
        case 'inline':
          // For inline, we'll expand with hierarchy data
          // The parent component should handle this via onMCQClick
          const inlineHierarchyParams = createMCQNavigationParams(item);
