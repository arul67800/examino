...
import { type HierarchyMode } from '../config/hierarchy-config';
...
interface HierarchyItemProps {
  ...
  onPublishToggle?: (itemId: string, isPublished: boolean) => void;
  onSaveEdit?: () => void;
  onCancelEdit?: () => void;
  onEditNameChange?: (value: string) => void;
  getTypeByLevel: (level: number) => string;
  allHierarchyItems?: any[]; // Add root hierarchy items for building complete chains
}
      ...
      >
        ...
        <div className="flex items-center space-x-2 ml-auto">
          ...
          <HierarchyItemActions
            ...
            allHierarchyItems={allHierarchyItems}
            ...
            onPublishToggle={onPublishToggle ? (e, itemId, isPublished) => {
              e.stopPropagation();
              onPublishToggle(itemId, isPublished);
            } : undefined}
          />
        </div>
      </div>
